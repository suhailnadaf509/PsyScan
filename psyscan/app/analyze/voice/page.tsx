          ...
          <div>
            <Card className="overflow-hidden border-purple-200 dark:border-purple-800">
              <div className="bg-gradient-to-r from-purple-500 to-fuchsia-500 p-4 text-white">
                ...
                <p className="text-sm text-purple-100">Speak naturally for at least 30 seconds for best results</p>
              </div>
                    ...
                    {isRecording ? (
                      ...
                      <div className="flex w-full flex-col items-center">
                        ...
                        <div className="mb-4 flex items-center space-x-4">
                          ...
                          <div className="text-purple-700 dark:text-purple-300">{formatTime(recordingTime)}</div>
                        </div>
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <div className="text-sm text-purple-700 dark:text-purple-300">Tap record to start</div>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex flex-wrap gap-3 justify-center">
                    {!audioUrl ? (
                      ...
                      <>
                        ...
                        <Button onClick={resetRecording} variant="outline" className="border-gray-300 text-gray-600">
                          Reset
                        </Button>
                      </>
                    ) : (
            ...
            {analysisComplete ? (
              <Card className="border-fuchsia-200 dark:border-fuchsia-800">
                <div className="bg-gradient-to-r from-fuchsia-500 to-pink-500 p-4 text-white">
                  ...
                  <p className="text-sm text-fuchsia-100">Your emotional well-being assessment</p>
                </div>
                <CardContent className="p-6">
                  <EmotionResults />
                </CardContent>
              ...
              <Card className="border-fuchsia-200 dark:border-fuchsia-800 bg-gradient-to-br from-fuchsia-50 to-pink-50 dark:from-fuchsia-900/30 dark:to-pink-900/30">
                <div className="bg-gradient-to-r from-fuchsia-500 to-pink-500 p-4 text-white">
                  ...
                  <p className="text-sm text-fuchsia-100">Understanding the voice analysis process</p>
                </div>
                <CardContent className="p-6">
                  <div className="space-y-6">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h3 className="font-medium text-fuchsia-700 dark:text-fuchsia-300">Record Your Voice</h3>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Speak naturally for at least 30 seconds about how your day is going.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h3 className="font-medium text-fuchsia-700 dark:text-fuchsia-300">AI Analysis</h3>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Our AI analyzes tone, pitch, speech patterns, and vocal energy.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h3 className="font-medium text-fuchsia-700 dark:text-fuchsia-300">Get Your Results</h3>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <div className="rounded-lg bg-fuchsia-100 p-4 dark:bg-fuchsia-900/50">
                      <p className="text-sm text-fuchsia-700 dark:text-fuchsia-300">
                        <strong>Privacy Note:</strong> Your voice recordings are processed securely and are not stored
